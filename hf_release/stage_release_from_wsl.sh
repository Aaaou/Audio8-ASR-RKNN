...
cp "$src/encoder_f1600/audio_encoder_f1600_fp16.rknn" "$dst/encoder/"
...
cp "$src/audio_adapter_h208_t200/audio_adapter_h208_t200_fp16.rknn" "$dst/adapter/"
...
cp "$src/prefill_kv_s210/prefill_kv_s210_fp16.rknn" "$dst/prefill/"
